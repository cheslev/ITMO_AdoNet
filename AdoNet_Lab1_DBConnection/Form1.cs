...
namespace AdoNet_Lab1_DBConnection
{
    public partial class DBConnection : Form
    {
        ...
        private async void асинхронноеПодключениеToolStripMenuItem_Click(object sender, EventArgs e)
        {
            {
                try
                {
        ...
        StateChangeEventArgs e)
        {
            ...
            асинхронноеПодключениеToolStripMenuItem.Enabled =
            (e.CurrentState == ConnectionState.Closed);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (connection)
            {
                ...
                command.CommandText = "USE[Northwind] SELECT COUNT(*) FROM[dbo].[Products]";
                try
                {
        ...
        public partial class WorkWithDataBase : Form
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                int number =
               WorkWithDataBase.ExecuteScalarMetod(connectionString, "USE [Northwind] SELECT COUNT(*) FROM [dbo].[Products]");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    command.CommandText = "USE [Northwind] INSERT INTO [Products] ([ProductName], [UnitPrice], [QuantityPerUnit]) VALUES('Wrong size', 12, '1 boxes')";
                    command.ExecuteNonQuery();
                    command.CommandText = "USE [Northwind] INSERT INTO [Products] ([ProductName], [UnitPrice], [QuantityPerUnit]) VALUES('Wrong color', 25, '100 ml')";
                    command.ExecuteNonQuery();
